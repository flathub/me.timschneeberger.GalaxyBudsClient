...
python flatpak-dotnet-generator.py --freedesktop 24.08  --runtime linux-arm64 --dotnet 10 sources-arm64.json --only-arches aarch64 ../GalaxyBudsClient/GalaxyBudsClient/GalaxyBudsClient.csproj 
```
